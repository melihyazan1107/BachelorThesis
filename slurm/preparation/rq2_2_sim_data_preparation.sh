#!/bin/bash
#SBATCH --job-name=rq2_2_sim_dataprep
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/preparation/logs/rq2_2_sim_dataprep_%j.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/preparation/logs/rq2_2_sim_dataprep_%j.log
...
# =========================================
# 3. AUSFÜHRUNG RQ2.2-sim LABEL-POISONING
# =========================================
...
RQ_CONFIG="${REPO_ROOT}/src/yaml/preparation/rq2_2_sim_data_preparation.yaml"
...
if [ ${EXIT_CODE} -eq 0 ]; then
    ...
    find "${PROCESSED}/poisoned/RQ2.2-sim" -name 'labels_*.pt' | sort
    echo "Anzahl: $(find "${PROCESSED}/poisoned/RQ2.2-sim" -name 'labels_*.pt' | wc -l)"
fi
