#!/bin/bash
#SBATCH --job-name=rq3_gce_resnet18
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_gce_resnet18_%A_%a.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_gce_resnet18_%A_%a.log
...
# RQ3 erzeugt KEIN eigenes Poisoning, sondern trainiert gegen die bestehenden Label-Tensoren
# beider Angriffe. Geprueft wird nur der Seed dieses Array-Tasks.
MISSING=0
