#!/bin/bash
#SBATCH --job-name=rq3_none_resnet18
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_none_resnet18_%A_%a.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_none_resnet18_%A_%a.log
