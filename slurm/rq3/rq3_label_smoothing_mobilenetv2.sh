#!/bin/bash
#SBATCH --job-name=rq3_label_smoothing_mobilenetv2
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_label_smoothing_mobilenetv2_%A_%a.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_label_smoothing_mobilenetv2_%A_%a.log
...
echo "Erwartet: 1 clean + 2 Angriffe x 5 Raten = 11 Laeufe (~3.3 h)."
echo ""
