#!/bin/bash
#SBATCH --job-name=rq3_gmm_filter_mobilenetv2
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_gmm_filter_mobilenetv2_%A_%a.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq3/logs/rq3_gmm_filter_mobilenetv2_%A_%a.log
