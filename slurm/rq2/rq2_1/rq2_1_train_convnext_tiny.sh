#!/bin/bash
#SBATCH --job-name=rq2_1_train_convnext_tiny
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_1/logs/rq2_1_train_convnext_tiny_%A_%a.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_1/logs/rq2_1_train_convnext_tiny_%A_%a.log
#SBATCH --array=0-2
...
TRAIN_CONFIG="${REPO_ROOT}/src/yaml/rq2/rq2_1/rq2_1_train_convnext_tiny_seed${SEED}.yaml"
...
echo "Ausgabe:          ${REPO_ROOT}/experiments/RQ2/convnext_tiny/seed_${SEED}"
echo ""
...
EXP_DIR="${REPO_ROOT}/experiments/RQ2/convnext_tiny/seed_${SEED}"
if [ -d "${EXP_DIR}" ]; then
    echo ""
