#!/bin/bash
#SBATCH --job-name=rq2_1_train_resnet18
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_1/logs/rq2_1_train_resnet18_%j.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_1/logs/rq2_1_train_resnet18_%j.log
...
TRAIN_CONFIG="${REPO_ROOT}/src/yaml/rq2/rq2_1/rq2_1_train_resnet18.yaml"
...
echo "Ausgabe:          ${REPO_ROOT}/experiments/RQ2/resnet18"
echo ""
...
EXP_DIR="${REPO_ROOT}/experiments/RQ2/resnet18"
if [ -d "${EXP_DIR}" ]; then
    echo ""
