#!/bin/bash
#SBATCH --job-name=rq2_2_dissim_train_convnext_tiny
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_2_dissim/logs/rq2_2_dissim_train_convnext_tiny_%A_%a.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_2_dissim/logs/rq2_2_dissim_train_convnext_tiny_%A_%a.log
#SBATCH --array=0-2
...
# =========================================
# 3. AUSFÜHRUNG RQ2.2-dissim TRAINING (${MODEL})
# =========================================
...
TRAIN_CONFIG="${REPO_ROOT}/src/yaml/rq2/rq2_2_dissim/rq2_2_dissim_train_convnext_tiny_seed${SEED}.yaml"
...
for r in 0.05 0.10 0.20 0.50 1.00; do
    lbl="${PROCESSED}/poisoned/RQ2.2-dissim/seed_${SEED}/labels_${r}.pt"
    if [ ! -f "${lbl}" ]; then
        echo "FEHLT: ${lbl}" >&2
        MISSING=$((MISSING + 1))
    fi
...
echo "Forschungsfrage:  RQ2.2-dissim"
echo "Modell:           ${MODEL}"
echo "Trainings-Config: ${TRAIN_CONFIG}"
echo "Ausgabe:          ${REPO_ROOT}/experiments/RQ2.2-dissim/convnext_tiny/seed_${SEED}"
echo ""
...
EXP_DIR="${REPO_ROOT}/experiments/RQ2.2-dissim/convnext_tiny/seed_${SEED}"
if [ -d "${EXP_DIR}" ]; then
    echo ""
