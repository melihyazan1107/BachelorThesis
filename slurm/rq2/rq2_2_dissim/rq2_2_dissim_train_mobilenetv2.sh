#!/bin/bash
#SBATCH --job-name=rq2_2_dissim_train_mobilenetv2
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_2_dissim/logs/rq2_2_dissim_train_mobilenetv2_%j.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq2/rq2_2_dissim/logs/rq2_2_dissim_train_mobilenetv2_%j.log
...
TRAIN_CONFIG="${REPO_ROOT}/src/yaml/rq2/rq2_2_dissim/rq2_2_dissim_train_mobilenetv2.yaml"
...
echo "Ausgabe:          ${REPO_ROOT}/experiments/RQ2.2-dissim/mobilenetv2"
echo ""
...
EXP_DIR="${REPO_ROOT}/experiments/RQ2.2-dissim/mobilenetv2"
if [ -d "${EXP_DIR}" ]; then
    echo ""
