#!/bin/bash
#SBATCH --job-name=rq1_train_resnet18
#SBATCH --output=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq1/logs/rq1_train_resnet18_%j.log
#SBATCH --error=/home/yazanme/BachelorThesis/BachelorThesis/slurm/rq1/logs/rq1_train_resnet18_%j.log
